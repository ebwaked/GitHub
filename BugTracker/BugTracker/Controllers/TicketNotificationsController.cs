...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        {
            var ticketNotifications = db.TicketNotifications.Include(t => t.Tickets).Include(t => t.User);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId")] TicketNotification ticketNotification)
        {
            ...
            ViewBag.UserId = new SelectList(db.ApplicationUsers, "Id", "Email", ticketNotification.UserId);
            return View(ticketNotification);
        }
